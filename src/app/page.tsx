...
const FEATURES = [
  {
    ...
    desc: "Счета, карты, вклады и операции — в одной картине. Видите остаток, обязательные платежи и свободный ресурс.",
    color: "#3629B7",
    link: "/dashboard",
...
const HOW_IT_WORKS = [
  { step: "01", title: "Создайте аккаунт", desc: "Задайте email и пароль. До добавления данных вы видите, что именно будет использоваться.", icon: Shield },
  { step: "02", title: "Добавьте данные", desc: "Загрузите выписку или внесите одну операцию вручную. Можно начать с небольшого объёма.", icon: FileSpreadsheet },
  { step: "03", title: "Получите разбор", desc: "Увидите категории, отклонения, расчёт эффекта и ограничения рекомендации.", icon: Sparkles },
  { step: "04", title: "Выберите следующий шаг", desc: "Поставьте цель, выполните действие и проверьте результат. Игровой режим помогает не бросить.", icon: Target },
];
...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="border-b border-[#E5E5EA] bg-white py-14 md:py-18">
      ...
      <section id="features" className="py-20 md:py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-[#8E8E93] max-w-2xl mx-auto text-lg">Счета, аналитика, Кэшик и игровые цели — в одном спокойном рабочем пространстве.</p>
          </div>
